...
Aug 8, 2024 — This notebook demonstrates an end-to-end Retrieval-Augmented Generation (RAG) pipeline. We will extract data from Jira using PyAirbyte, store it in a Pinecone v...
Favicon
Airbyte
Step-by-Step Guide to Building a RAG-Powered JIRA ...
Jun 6, 2024 — * Step 1: Setting Up the Flask Web Application. First, we'll set up a Flask web application to serve as the interface for querying our indexed JIRA tickets. Cod...
